...
class ProdutosTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->setDisplayField('nome_prod');
    ...
    public function validationDefault(Validator $validator): Validator
    {
        $validator
            ->scalar('nome_prod')
            ->maxLength('nome_prod', 220)
            ->requirePresence('nome_prod', 'create')
            ->notEmptyString('nome_prod');

        $validator
            ->scalar('principio_ativo')
            ->maxLength('principio_ativo', 220)
            ->requirePresence('principio_ativo', 'create')
            ->notEmptyString('principio_ativo');

        $validator
            ->scalar('indicacao')
            ->maxLength('indicacao', 220)
